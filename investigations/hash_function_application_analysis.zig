...
pub fn main() !void {
    ...
    log.print("=== Hash Function Application Analysis ===\n", .{});
    ...
    log.print("Hash Result: {any}\n", .{hash_result});

    // Analyze the specific differences in hash function application
    log.print("\n=== Hash Function Application Differences ===\n", .{});
    log.print("Rust: Uses separate iterators for left and right child\n", .{});
    log.print("Zig: Concatenates left and right child into single array\n", .{});

    // Show the difference in input structure
    log.print("Rust Input Structure:\n", .{});
    log.print("  [parameter(5), tweak(2), left(8), right(8)]\n", .{});
    log.print("Zig Input Structure:\n", .{});
    log.print("  [parameter(5), tweak(2), left(8), right(8)]\n", .{});

    log.print("Both use the same input structure!\n", .{});
