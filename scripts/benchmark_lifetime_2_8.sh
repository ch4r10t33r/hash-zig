#!/bin/bash
# Benchmark script for lifetime 2^8

echo "Running benchmark for Lifetime 2^8..."
echo ""
...
in_lifetime_2_8 && /Key Generation Time:/ {
...
in_lifetime_2_8 && /✅ All tests passed for lifetime 2\^8/ {
    print ""
    print "============================================================"
    print "LIFETIME 2^8 PERFORMANCE METRICS"
    print "============================================================"
    print ""
